...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "dbishop@hamiltontn.gov", ZipCode = "12345" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("dbishop@hamiltontn.gov","Forms"),null);
